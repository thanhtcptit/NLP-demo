...
const apiUrl = () => `${API_ROOT}/predict/transformer_decoder_seq`
const apiUrlInterpret = () => `${API_ROOT}/interpret/transformer_decoder_seq`
const apiUrlAttack = () => `${API_ROOT}/attack/transformer_decoder_seq`

const NAME_OF_INPUT_TO_ATTACK = "tokens"
const NAME_OF_GRAD_INPUT = "grad_input_1"

const title = "Seq2Seq Transformer Decoder for Vietnamese Tone Prediction";
...
const DEFAULT_MODEL = "Seq2Seq Transformer Decoder"
