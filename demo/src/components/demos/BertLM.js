...
const apiUrl = () => `${API_ROOT}/predict/bert-lm`
const apiUrlInterpret = () => `${API_ROOT}/interpret/bert-lm`
const apiUrlAttack = () => `${API_ROOT}/attack/bert-lm`

const NAME_OF_INPUT_TO_ATTACK = "tokens"
const NAME_OF_GRAD_INPUT = "grad_input_1"

const title = "Bert Masked Language Modeling";
