...
const apiUrl = () => `${API_ROOT}/predict/distilmbert`
const apiUrlInterpret = () => `${API_ROOT}/interpret/distilmbert`
const apiUrlAttack = () => `${API_ROOT}/attack/distilmbert`
const apiRandTitle = () => `${API_ROOT}/rand`

const NAME_OF_INPUT_TO_ATTACK = "tokens"
const NAME_OF_GRAD_INPUT = "grad_input_1"
const title = "DistilmBERT Multilingual Model";
...
const description = (
<span>
DistilmBERT multilingual model pretrained with the supervision of <ExternalLink href="https://github.com/google-research/bert"
target="_blank" rel="noopener">BERT-Base, Multilingual Cased</ExternalLink> on the concatenation of Wikipedia in 104 different languages.<br/>
The model supports the 104 languages listed <ExternalLink href="https://github.com/google-research/bert/blob/master/multilingual.md#list-of-languages"
target="_blank" rel="noopener">here</ExternalLink>.
</span>
)
