...
const apiUrl = () => `${API_ROOT}/predict/mbert`
const apiUrlInterpret = () => `${API_ROOT}/interpret/mbert`
const apiUrlAttack = () => `${API_ROOT}/attack/mbert`
const apiRandTitle = () => `${API_ROOT}/rand`

const NAME_OF_INPUT_TO_ATTACK = "tokens"
const NAME_OF_GRAD_INPUT = "grad_input_1"
const title = "BERT Multilingual Model";
...
const description = (
<span>
BERT Multilingual Model with 12-layer, 768-hidden, 12-heads, 110M parameters<br/>
